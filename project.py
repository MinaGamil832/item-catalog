...
# Show all restaurants- home page
@app.route('/')
...
def editRestaurant(restaurant_id):
    ...
    if editedRestaurant.user_id != login_session['user_id']:
        return "<script>function myFunction(){alert('You are not authorized to edit this restaurant.');}</script><body onload = 'myFunction()'>" "# noqa"
...
# make sure the server only run if the script executed from python
if __name__ == '__main__':
    # flask use it to make session for users when will be onlin
    app.secret_key = 'super_secret_key'
    # automatic reload after make changes
    app.debug = True
    # run the local server with app
